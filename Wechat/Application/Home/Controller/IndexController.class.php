...
class IndexController extends Controller{
    ...
    public function index($id = ''){
        //调试
        try{
            $appid = 'wx0a32ca8a98147412'; //AppID(应用ID)
            $token = 'jungege'; //微信后台填写的TOKEN
            $crypt = 'BSdWwcbHitBuZ2ORu5uNK4t8qspbIjxs2XD6wGXHZ3G'; //消息加密KEY（EncodingAESKey）
        ...
        switch ($data['MsgType']) {
            case Wechat::MSG_TYPE_EVENT:
                switch ($data['Event']) {
                    ...
                    default:
                        $wechat->replyText("欢迎访问一家人公众平台！您的事件类型：{$data['Event']}，EventKey：{$data['EventKey']}");
                        break;
                }
                break;
            ...
            case Wechat::MSG_TYPE_TEXT:
                switch ($data['Content']) {
                    case '文本':
                        $wechat->replyText('欢迎访问一家人公众平台，这是文本回复的内容！');
                        break;
                    ...
                    case '多图文':
                     ...
                     case '葛军':
                        $wechat->replyNewsOnce(
                            "相信军哥，没有错。嘻嘻！",
                            "军哥V587，一切都是浮云", 
                            "http://u1694584.jisuwebapp.com/s?id=2655173",
                            "http://cdn.sinacloud.net/myboy-video/5141398762829501.jpg?KID=sina,17xe0u7It84n0jPtyZHF&Expires=1483280473&ssig=2EY7BtdkCP"
                        ); //回复单条图文消息
                        break;
                    
                    default:
                        $wechat->replyText("欢迎访问一家人公众平台！您输入的内容是：{$data['Content']}");
                        break;
                }
                break;
     ...
     */
    public function upload($type = 'thumb'){
        $appid     = 'wx0a32ca8a98147412';
        $appsecret = '23933d7365552cf1a278752f5b136670';
